...
namespace _1._1._19
{
    ...
    class Fibnacci
    {
        // ong 类型不够大，换成 UINT64 类型
        // 于保存计算结果的数组，UInt64? 代表可以赋值为普通 UInt64 类型的值以及 null 值
        ...
        public static UInt64? BetterF(int N)
        {
            ...
            if (fibnacciResults[N] != null)     // 果已经计算过则直接读取已知值
            {
