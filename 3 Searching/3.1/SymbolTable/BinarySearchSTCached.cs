...
{
    /// <summary>
    /// 符号表，基于有序表并应用了二分查找优化和缓存技术。
    /// </summary>
    /// <typeparam name="TKey">键类型。</typeparam>
    /// <typeparam name="TValue">值类型。</typeparam>
    public class BinarySearchSTCached<TKey, TValue> : IST<TKey, TValue>, IOrderedST<TKey, TValue>
        where TKey : IComparable<TKey>
    {
        ...
        /// 构造一个空的符号表。
        /// </summary>
        public BinarySearchSTCached() : this(INIT_CAPACITY) { }
